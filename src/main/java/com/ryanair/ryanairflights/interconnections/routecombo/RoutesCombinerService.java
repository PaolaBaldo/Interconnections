...
public class RoutesCombinerService {
	...
	public RouteCombo combineRoutes(List<Route> routesByDeparture, List<Route> routesByArrival, String arrivalAirport, int year, int month, LocalDateTime requestedDepartureDateTime, LocalDateTime requestedArrivalDateTime){
